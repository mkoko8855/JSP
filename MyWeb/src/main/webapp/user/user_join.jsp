...
<title>Insert title here</title>
   ...
   <script src="/MyWeb/js/member.js"></script>  <%--이건 아래 onclick 이벤트 처리 해놓은 것이다. js폴더에 member.js가보면 앎 --%>
      ...
      <div class="col-md-offset-2 col-md-4">
         <div class="panel" style="width:200%;">
            ...
            <div class="panel-body">
               <form action="/MyWeb/join.user" method="post" name="reg_form" style="margin-bottom: 0;"> <%--서블릿클래스로 보내줄 것이라는것을 /을 보면 알수있지~ --%>
                  <table
                     ...
                     <tr>
                        <td><input type="text" name="id" <%--겟파라미터를 하기위해 name이 중요하겠지--%>
                     ...
                     <tr>
                        <td><input type="password" size="17"
                           name="pw_check" class="form-control" <%--여기 name은 집중안해도됨--%>
